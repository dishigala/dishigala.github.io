...
function showModal(name){
    ...
    var innerHtml = `
        ...
        <input class="form-control" type="password" id="password" placeholder="What does `+name+` call you?">
...
function populateDetails(name) {
    ...
    var innerHtml = `
        ...
        <h1>`+name+`</h1>
        <hr>
        <h2> View the Memories </h2>
        <div id="personal-gallery"> </div>
        <hr>
